...
const InfoBar: React.FC<InfoBarProps> = ({
  ...
  // Force isTimerActive to be treated as a boolean
  const timerIsActive = Boolean(isTimerActive);
  ...
  // For debugging
  console.log('InfoBar state:', { isTimerActive, timerIsActive, selectedProject, selectedSubproject, time });

  // Force timerIsActive to be true if we have a selectedProject, selectedSubproject, and time > 0
  const shouldShowTimerView = timerIsActive || (!!selectedProject && !!selectedSubproject && time > 0);
